...
#define PREFTOGGLE_2_AUTO_AIM_MEDICINE (1<<10) // 1024
...
#define PREFTOGGLE_3_INWORLD_SPRITES (1<<7) // 128
...
#define TOGGLES_3_DEFAULT (PREFTOGGLE_3_RUNECHAT_LOOC|PREFTOGGLE_3_INWORLD_SPRITES)
